...
const MyProfile = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-800 border-2 transition-colors duration-300">
        ...
        <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-8">
                   <div className="bg-white dark:bg-gray-800 p-8 rounded-[2rem] border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 flex-1">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                            <i className="fa-solid fa-laptop-code text-gray-700 dark:text-gray-300"></i> {t('profile.technologies')}
                        </h3>
                   ...
                   <div className="bg-white dark:bg-gray-800 p-8 rounded-[2rem] border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                            <i className="fa-solid fa-graduation-cap text-gray-700 dark:text-gray-300"></i> {t('profile.hardSkills')}
                        </h3>
                        
                        <div className="space-y-6">
                             <div>
                                <h4 className="text-sm uppercase tracking-wider text-gray-500 dark:text-gray-400 font-semibold mb-3">{t('profile.languages')}</h4>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-100 dark:border-gray-600">
                                        <div className="font-semibold text-gray-800 dark:text-gray-100">{t('profile.spanish')}</div>
                                        <div className="text-sm text-gray-500 dark:text-gray-300">{t('profile.native')}</div>
                                    </div>
                                    <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-100 dark:border-gray-600">
                                        <div className="font-semibold text-gray-800 dark:text-gray-100">{t('profile.english')}</div>
                                        <div className="text-sm text-gray-500 dark:text-gray-300">{t('profile.basic')}</div>
                                    </div>
                                </div>
                             </div>
                             
                             <div>
                                <h4 className="text-sm uppercase tracking-wider text-gray-500 dark:text-gray-400 font-semibold mb-3">{t('profile.knowledge')}</h4>
                ...
                <div className="flex flex-col h-full">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-[2rem] border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 h-full">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                            <i className="fa-solid fa-users text-gray-700 dark:text-gray-300"></i> {t('profile.softSkills')}
                        </h3>
                            ...
                            <div className="grid grid-cols-1 gap-8">
                               {[
                                 ...
                                 { icon: "fa-puzzle-piece", title: t('profile.problemSolving'), desc: t('profile.problemSolvingDesc') }
                                   ...
                                   <div key={index} className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600">
                                       <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-600 border border-gray-200 dark:border-gray-500 flex items-center justify-center shrink-0 text-gray-700 dark:text-gray-200">
                                           <i className={`fa-solid ${skill.icon}`}></i>
                                       </div>
                                       <div>
                                           <h4 className="font-bold text-gray-800 dark:text-gray-100">{skill.title}</h4>
                                           <p className="text-sm text-gray-500 dark:text-gray-300 mt-1">{skill.desc}</p>
                                       </div>
                                   </div>
                               ))}
                            </div>
            ...
            {/* 1. Work Experience */}
            <div className="bg-white dark:bg-gray-800 p-8 md:p-10 rounded-[2rem] border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">
                   <i className="fa-solid fa-briefcase text-gray-700 dark:text-gray-300"></i> {t('profile.workExperience')}
                </h3>
                <div className="relative pl-8 border-l-2 border-gray-200 dark:border-gray-600 space-y-10">
                    <div className="relative group">
                        {/* Dot */}
                        <span className="absolute -left-[43px] top-1.5 h-5 w-5 rounded-full border-4 border-white dark:border-gray-800 bg-gray-900 dark:bg-gray-100 group-hover:scale-110 transition-transform"></span>
                        
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline gap-1 mb-2">
                           <h4 className="text-xl font-bold text-gray-800 dark:text-gray-100">{t('profile.jobTitle')}</h4>
                           <span className="text-sm font-medium text-gray-500 dark:text-gray-800 bg-gray-100 dark:bg-gray-200 px-3 py-1 rounded-full w-fit">05/2025 – 09/2025</span>
                        </div>
                        
                        <div className="text-base text-gray-700 dark:text-gray-300 font-semibold mb-3">
                            {t('profile.company')}
                        </div>
