      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6 max-w-4xl mx-auto">
          ...
          <div className="flex-1">
            <div className="bg-white rounded-[2rem] border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow duration-300 h-full flex flex-col justify-center">
          ...
          {/* Right: GIF */}
          <div className="flex-1">
            <div className="bg-white rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white h-full">
